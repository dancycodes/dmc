...
/**
 * F-195: Store Announcement Form Request
 *
 * BR-311: Only admins can create announcements (auth middleware enforced at route level)
 * BR-312: Target audience options: all_users, all_cooks, all_clients, specific_tenant
 * BR-313: For specific_tenant, target_tenant_id is required
 * BR-314: Announcement text required, max 2000 characters
 * BR-318: Scheduled time must be minimum 5 minutes in the future
 */
class StoreAnnouncementRequest extends FormRequest
{
    /**
     * Minimum number of minutes in the future for scheduled announcements.
     */
