...
class UpdatePickupLocationRequest extends FormRequest
{
     ...
     *
     * BR-300: Only users with location management permission can edit pickup locations.
     */
     ...
     *
     * BR-295: Location name required in both EN and FR.
     * BR-296: Town and quarter selection required.
     * BR-297: Address required, max 500 characters.
     *
