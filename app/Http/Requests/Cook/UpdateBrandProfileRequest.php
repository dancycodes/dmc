...
class UpdateBrandProfileRequest extends FormRequest
{
     ...
     *
     * BR-195: Only users with profile edit permission for this tenant can submit.
     */
    public function authorize(): bool
    {
        return $this->user()->can('can-manage-brand');
    }

    /**
     * Get the validation rules that apply to the request.
     *
     * F-080: Cook Brand Profile Edit validation rules.
     * BR-187: Brand name required in both EN and FR; max 100 characters each.
     * BR-188: If bio provided in one language, it must be provided in both; max 1000 chars.
     * BR-189: WhatsApp number required; must be valid Cameroon format (+237).
     * BR-190: Phone number optional; must be valid Cameroon format if provided.
     ...
     *
     * BR-188: If bio is provided in one language, it must be provided in both.
     */
     ...
     *
     * BR-189/BR-190: Normalize phone numbers (strip spaces/dashes, ensure +237 prefix).
     */
