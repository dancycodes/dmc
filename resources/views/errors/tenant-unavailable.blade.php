...
<body class="bg-surface dark:bg-surface text-on-surface dark:text-on-surface font-sans antialiased">
    <div class="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full text-center">
            <div class="mb-8">
                <span class="inline-flex items-center justify-center w-20 h-20 rounded-full bg-info-subtle dark:bg-info-subtle mb-6">
                    <svg class="w-10 h-10 text-info dark:text-info" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                    </svg>
                </span>
                <h1 class="text-3xl font-bold text-on-surface-strong dark:text-on-surface-strong mb-2">{{ __('Site Unavailable') }}</h1>
                <p class="text-on-surface dark:text-on-surface text-base leading-relaxed">
