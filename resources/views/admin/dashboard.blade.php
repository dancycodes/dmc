...
<div class="space-y-6">
    ...
    {{-- Quick stats placeholder (to be populated by F-057) --}}
            ...
            <div class="bg-surface-alt dark:bg-surface-alt rounded-lg border border-outline dark:border-outline p-4 sm:p-5">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-on-surface-strong mt-1">{{ $stat['value'] }}</p>
                    </div>
    ...
    <p class="text-sm text-on-surface">
        {{ __('Detailed analytics and management features will be available in upcoming modules.') }}
    </p>
</div>
@endsection
